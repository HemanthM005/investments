...
const SECTORS: SectorSection[] = [
  {
    ...
    companies: [
      ...
      { name: 'Paras Defence & Space', ticker: 'PARAS', type: 'Private · Drones, Optics, Space & Satellite Systems', desc: 'One of the few Indian private companies in defence drones, space equipment, and high-tech optics. Works on electro-optics, surveillance drones, and satellite systems. High growth runway but small-cap with volatility.', metrics: [{ k: 'Focus', v: 'Drones + Optics' }, { k: 'Upside', v: 'Very High', up: true }], ratings: [{ label: 'Growth', value: '8.8/10', pct: 88, color: '#10b981' }, { label: 'Risk', value: 'High', pct: 70, color: '#ef4444' }], tags: [{ text: 'Drones', variant: 'green' }, { text: 'Space Optics', variant: 'green' }, { text: 'Volatile', variant: 'red' }], links: { screener: 'https://www.screener.in/company/PARAS/', mc: 'https://www.moneycontrol.com/india/stockpricequote/defence/parasdefencespacetech/PDST', nse: 'https://www.nseindia.com/get-quotes/equity?symbol=PARAS' } },
    ],
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Paras Defence & Space', ticker: 'PARAS', type: 'Private · Drones, Space Optics & Satellite Systems', desc: 'Unique private-sector position in both defence drones and space technology. Focus on electro-optics, surveillance drones, and satellite systems. High growth runway as India\'s space sector opens up.', metrics: [{ k: 'Focus', v: 'Optics + Drones' }, { k: 'Upside', v: 'Very High', up: true }], ratings: [{ label: 'Growth', value: '9/10', pct: 90, color: '#b47afc' }, { label: 'Risk', value: 'High', pct: 72, color: '#ef4444' }], tags: [{ text: 'Space Optics', variant: 'green' }, { text: 'Drones', variant: 'green' }, { text: 'Volatile', variant: 'red' }], links: { screener: 'https://www.screener.in/company/PARAS/', mc: 'https://www.moneycontrol.com/india/stockpricequote/defence/parasdefencespacetech/PDST', nse: 'https://www.nseindia.com/get-quotes/equity?symbol=PARAS' } },
...
const OVERVIEW_ROWS = [
  ...
  { company: 'Paras Defence', link: 'https://www.screener.in/company/PARAS/', sector: 'Drones/Space', growth: '★★★★★', risk: 'High', riskType: 'risk', horizon: '5-10 yrs', outlook: 'Speculative', outlookType: 'caut', nse: 'https://www.nseindia.com/get-quotes/equity?symbol=PARAS' },
                ...
                <tbody>
                  {OVERVIEW_ROWS.map((row, i) => (
                    <tr key={i} className="border-b border-[#2a2d3e] hover:bg-[#12151f] transition-colors">
                      <td className="px-3 py-2.5"><a href={row.link} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline font-semibold">{row.company}</a></td>
                      ...
                      <td className="px-3 py-2.5"><a href={row.nse} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline">NSE ↗</a></td>
                    </tr>
                  ))}
                </tbody>
              </table>
